...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function createTestTransactions(): array
    {
        ...
        Transaction::query()->insert([
            ['id' => Uuid::uuid4()->toString(), 'employee_id' => $users[0]->id, 'hours' => 2],
            ['id' => Uuid::uuid4()->toString(), 'employee_id' => $users[0]->id, 'hours' => 3],
            ['id' => Uuid::uuid4()->toString(), 'employee_id' => $users[1]->id, 'hours' => 5],
            ['id' => Uuid::uuid4()->toString(), 'employee_id' => $users[1]->id, 'hours' => 6],
        ]);
        return $users;
    }
}
