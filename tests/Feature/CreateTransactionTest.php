...
class CreateTransactionTest extends TestCase
{
    ...
    public function testCreateTransactionWithInvalidData()
    {
        ...
        $this->assertRequestValidation($this->uri, ['employee_id' => $user->id], "Не указано кол-во отработанных часов" );
        $this->assertRequestValidation($this->uri, ['employee_id' => $user->id, 'hours' => 4.5], "Кол-во часов должно быть целым числом" );
        $this->assertRequestValidation($this->uri, ['employee_id' => $user->id, 'hours' => 0], "Кол-во отработанных часов должно быть больше 0" );
    }
